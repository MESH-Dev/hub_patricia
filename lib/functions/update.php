...
function update_notifier_menu() {
	...
	$ignore = genesis_get_option( 'wsm_ignore_updates', 'patricia-settings' );
	if ( 1 == $ignore )
			return;
...
function get_latest_theme_version( $interval ) {
	...
	$notifier_file_url = 'http://www.web-savvy-marketing.com/files/theme-versions/patricia.xml';
